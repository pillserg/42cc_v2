...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StoredRequest.priority'
        db.add_column('store_requests_storedrequest', 'priority', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StoredRequest.priority'
        db.delete_column('store_requests_storedrequest', 'priority')
